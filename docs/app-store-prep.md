...
- Uygulama kaydı
- Bundle ID eşleşmesi
- Gizlilik politikası URL'si: GitHub Pages yayını sonrası `https://<domain>/privacy.html`
- Destek URL'si: GitHub Pages yayını sonrası `https://<domain>/support.html`
...
- Gizlilik politikası ve destek sayfasının hangi domain/GitHub Pages adresinde yayınlanacağı.
