...
- App Store ikon ve ekran goruntusu standardi `docs/app-store-assets.md` dosyasinda netlestirildi; `pictures/` klasorundeki ornekler tasarim referansi olarak eslendi ve final ekran goruntuleri `docs/app-store-screenshots/` altinda tutulacak.
